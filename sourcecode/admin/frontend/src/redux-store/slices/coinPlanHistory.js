...
export const fetchCoinPlanHistory = createAsyncThunk(
  ...
  async ({ page = 1, limit = 10, startDate = 'All', endDate = 'All', search = '' }, thunkAPI) => {
    try {
      const response = await axios.get(
        `${BASE_URL}/api/admin/coinplan/getCoinPurchaseHistory?start=${page}&limit=${limit}&startDate=${startDate}&endDate=${endDate}&search=${search}`,
        {
...
export const { setPage, setPageSize, setDateRange, setSearchQuery } = coinPlanHistorySlice.actions
