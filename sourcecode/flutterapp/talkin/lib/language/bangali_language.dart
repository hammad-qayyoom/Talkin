...
final Map<String, String> bnIN = <String, String>{
  ...
  EnumLocale.txtRandomCall.name: 'এলোমেলো কল',
  ...
  EnumLocale.txtListenerGuide.name:
      "1. আপনার ওয়ালেট ব্যালেন্স দেখায় যে আপনি যে সমস্ত কয়েন অর্জন করেছেন তাদের কাছ থেকে যারা আপনাকে শ্রোতা বলে ডাকে। কল চলাকালীন আপনার সময় এবং ব্যস্ততার জন্য এই কয়েনগুলি আপনাকে পুরস্কৃত করা হয়।\n\n2. ব্যবহারকারীরা কয়েন ক্রয় করে এবং আপনার মত শ্রোতাদের কল করে খরচ করে। যত বেশি ব্যবহারকারী আপনাকে কল করবেন, আপনি আপনার ওয়ালেটে তত বেশি কয়েন উপার্জন করবেন।\n\n3. প্ল্যাটফর্মের প্রত্যাহারের নিয়মের উপর নির্ভর করে অর্জিত কয়েন জমা করা যেতে পারে এবং পরে টাকা হিসাবে প্রত্যাহার করা যেতে পারে। আপনার ওয়ালেট ব্যালেন্স বাড়াতে সক্রিয়ভাবে জড়িত থাকুন।",
  ...
  EnumLocale.txtAllowRandomCall.name: "র‍্যান্ডম কলের অনুমতি দিন",
  EnumLocale.txtEarnMoney.name: "অর্থ উপার্জন",
  EnumLocale.txtPermissionAllow.name: "অনুমতি অনুমতি দিন",
  EnumLocale.txtAvailableForRondomConnect.name: "র্যান্ডম সংযোগের জন্য উপলব্ধ",
  EnumLocale.txtHostHomeNote.name:
      "অনুগ্রহ করে অপরিচিতদের কাছ থেকে প্রতারণামূলক তথ্য যেমন অর্থ স্থানান্তর, লটারি ইত্যাদি বিশ্বাস করবেন না। দয়া করে কোনো ব্যক্তিগত তথ্য যেমন পাসওয়ার্ড, মোবাইল নম্বর, ওটিপি ইত্যাদি শেয়ার করবেন না। অনুগ্রহ করে নগ্নতা, পর্নোগ্রাফি বা কোনো অশ্লীল কাজে লিপ্ত হবেন না।",
  EnumLocale.txtWithdrawCoin.name: "মুদ্রা প্রত্যাহার করুন",
  ...
  EnumLocale.txtWithdrawAmount.name: "টাকা উত্তোলন করুন",
  ...
  EnumLocale.txtWithdrawalDetails.name: "প্রত্যাহারের বিবরণ:-",
  ...
  EnumLocale.txtAmountWithdraw.name: "টাকা উত্তোলন",
  ...
  EnumLocale.txtRandomVideoCallRate.name: "র্যান্ডম ভিডিও কল রেট",
  EnumLocale.txtRandomAudioCallRate.name: "র্যান্ডম অডিও কল রেট",
  ...
  EnumLocale.txtHostHomeDescription.name:
      "অন্যদের সাহায্য করার সময় পুরস্কৃত পান! শ্রোতা হিসাবে, আপনি র্যান্ডম কলের সময় প্রতি মিনিটে টি কয়েন উপার্জন করতে পারেন। প্রয়োজনে কাউকে সহায়তা করুন এবং একই সাথে উপার্জন করুন।",
  ...
  EnumLocale.txtRanAudioCallConnect.name: "ব্যক্তিগত বিবরণ:",
  EnumLocale.txtRandomVideoCallConnect.name: "আমি এর জন্য উপলব্ধ",
  ...
  EnumLocale.txtListenerAvailableForRandomVideoCall.name: 'গোপনীয়তা নীতি.',
  EnumLocale.txtListenerAvailableForRandomAudioCall.name: 'ব্যক্তিগত ভিডিও কলের জন্য শ্রোতা উপলব্ধ।',
  ...
  EnumLocale.txtListenerDisableForRandomVideoCall.name: 'র্যান্ডম অডিও কলের জন্য শ্রোতা উপলব্ধ।',
  EnumLocale.txtListenerDisableForRandomAudioCall.name: 'ব্যক্তিগত ভিডিও কলের জন্য শ্রোতা অক্ষম করুন।',
