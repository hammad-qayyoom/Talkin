...
final Map<String, String> ptPT = {
  ...
  EnumLocale.txtRandomCall.name: 'Chamada aleatória',
  ...
  EnumLocale.txtShareListenersApp.name: "Aplicativo Share Listener",
  ...
  EnumLocale.txtDidYouLikeService.name: "Você gostou do serviço Listener?",
  ...
  EnumLocale.txtListenerGuide.name:
      "1. O saldo da sua carteira mostra o total de moedas que você ganhou de usuários que ligam para você como ouvinte. Essas moedas são recompensadas pelo seu tempo e engajamento durante a chamada. 2. Os usuários compram moedas e as gastam ligando para ouvintes como você. Quanto mais usuários ligam para você, mais moedas você ganha na sua carteira. 3. As moedas ganhas podem ser acumuladas e posteriormente sacadas como dinheiro, dependendo das regras de saque da plataforma. Continue interagindo ativamente para aumentar o saldo da sua carteira.",
  ...
  EnumLocale.txtAllowRandomCall.name: "Permitir chamada aleatória",
  EnumLocale.txtEarnMoney.name: "Ganhe dinheiro",
  EnumLocale.txtPermissionAllow.name: "Permissão Permitir",
  EnumLocale.txtAvailableForRondomConnect.name: "Disponível para conexão aleatória",
  EnumLocale.txtHostHomeNote.name:
      "Não confie em informações fraudulentas, como transferências de dinheiro, loterias, etc., vindas de estranhos. Não compartilhe informações pessoais, como senhas, números de celular, OTP, etc. Não pratique nudez, pornografia ou qualquer ato obsceno.",
  EnumLocale.txtWithdrawCoin.name: "Retirar Moeda",
  ...
  EnumLocale.txtWithdrawAmount.name: "Valor da retirada",
  ...
  EnumLocale.txtWithdrawalDetails.name: "Detalhes da retirada:",
  ...
  EnumLocale.txtAmountWithdraw.name: "Valor Saque",
  ...
  EnumLocale.txtRandomVideoCallRate.name: "Taxa de chamada de vídeo aleatória",
  EnumLocale.txtRandomAudioCallRate.name: "Taxa de chamada de áudio aleatória",
  ...
  EnumLocale.txtHostHomeDescription.name:
      "Seja recompensado enquanto ajuda os outros! Como ouvinte, você pode ganhar  moedas por minuto durante chamadas aleatórias. Apoie alguém necessitado e ganhe dinheiro ao mesmo tempo.",
  ...
  EnumLocale.txtRanAudioCallConnect.name: "Dados pessoais:",
  EnumLocale.txtRandomVideoCallConnect.name: "Estou disponível para",
  ...
  EnumLocale.txtListenerAvailableForRandomVideoCall.name: 'Política de Privacidade.',
  EnumLocale.txtListenerAvailableForRandomAudioCall.name: 'Ouvinte disponível para videochamada privada.',
  ...
  EnumLocale.txtListenerDisableForRandomVideoCall.name: 'Ouvinte disponível para chamada de áudio aleatória.',
  EnumLocale.txtListenerDisableForRandomAudioCall.name: 'Desativar ouvinte para videochamada privada.',
