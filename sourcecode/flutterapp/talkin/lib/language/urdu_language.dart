...
final Map<String, String> urPK = <String, String>{
  ...
  EnumLocale.txtRandomCall.name: 'بے ترتیب کال',
  ...
  EnumLocale.txtAllowRandomCall.name: "رینڈم کال کی اجازت دیں۔",
  EnumLocale.txtEarnMoney.name: "پیسے کمائیں۔",
  EnumLocale.txtPermissionAllow.name: "اجازت کی اجازت",
  EnumLocale.txtAvailableForRondomConnect.name: "رینڈم کنیکٹ کے لیے دستیاب ہے۔",
  ...
  EnumLocale.txtRandomVideoCallRate.name: "بے ترتیب ویڈیو کال کی شرح",
  EnumLocale.txtRandomAudioCallRate.name: "بے ترتیب آڈیو کال کی شرح",
  ...
  EnumLocale.txtRanAudioCallConnect.name: "ذاتی تفصیلات:",
  EnumLocale.txtRandomVideoCallConnect.name: "میں اس کے لیے دستیاب ہوں۔",
  ...
  EnumLocale.txtListenerAvailableForRandomVideoCall.name: 'رازداری کی پالیسی۔',
  EnumLocale.txtListenerAvailableForRandomAudioCall.name: 'سننے والا نجی ویڈیو کال کے لیے دستیاب ہے۔',
  ...
  EnumLocale.txtListenerDisableForRandomVideoCall.name: 'سننے والا رینڈم آڈیو کال کے لیے دستیاب ہے۔',
  EnumLocale.txtListenerDisableForRandomAudioCall.name: 'سننے والے کو نجی ویڈیو کال کے لیے غیر فعال کریں۔',
