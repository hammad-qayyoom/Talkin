...
class HostSelectGenderScreenAppBar extends StatelessWidget {
  const HostSelectGenderScreenAppBar({super.key});
...
class HostSelectGenderView extends StatelessWidget {
  const HostSelectGenderView({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        GetBuilder<HostSelectGenderScreenController>(
...
GetBuilder<GetxController> hostSaveGenderButton() {
  return GetBuilder<HostSelectGenderScreenController>(
    builder: (controller) {
      return Container(
        decoration: BoxDecoration(
          color: AppColors.white,
