abstract class Api {
  ...
  static const getFirebaseUidByDeviceUuid =
      "${baseUrl}api/user/getfirebaseIdByDeviceId";
  static const getFirebaseCustomToken =
      "${baseUrl}api/user/generateFirebaseCustomToken";
  ...
  static const identityProofs =
      "${baseUrl}api/user/identityProof/listIdentityProofs";
  ...
  static const listenersRequestCheck =
      "${baseUrl}api/user/expert/verifyExpertRequestStatus";
  ...
  static const searchChatUser =
      "${baseUrl}api/user/chatTopic/findChattedExpertsBySearch?";
  ...
  static const groupSessionParticipants =
      "${baseUrl}api/v2/sessions/group/participants?";
  ...
  static const groupSessionExpertPresence =
      "${baseUrl}api/v2/sessions/group/expert/presence";
  static const sessionGetAvailableSlots =
      "${baseUrl}api/v2/sessions/getAvailableSlots?";
  static const sessionBookSession = "${baseUrl}api/v2/sessions/bookSession";
  static const sessionCancelBooking =
      "${baseUrl}api/v2/sessions/cancelSessionBooking";
  static const sessionAccessCheck =
      "${baseUrl}api/v2/sessions/getSessionAccess";
  static const sessionReportCallOutcome =
      "${baseUrl}api/v2/sessions/reportSessionCallOutcome";
  static const sessionGetUserSessions =
      "${baseUrl}api/v2/sessions/getUserSessions?";
  static const sessionGetExpertSessions =
      "${baseUrl}api/v2/sessions/getExpertSessions?";
  static const expertSetAvailability =
      "${baseUrl}api/v2/experts/setAvailability";
  static const expertGetAvailability =
      "${baseUrl}api/v2/experts/getAvailability?";
  ...
  static const feedExpertsFollowStatus =
      "${baseUrl}api/v2/feed/experts/follow/status?";
  static const feedExpertsFollowing =
      "${baseUrl}api/v2/feed/experts/following?";
  static const feedPostsDeletePrefix = "${baseUrl}api/v2/feed/posts/";

  static const moderationReportUser =
      "${baseUrl}api/v2/moderation/reports/user";
  static const moderationReportChatMessage =
      "${baseUrl}api/v2/moderation/reports/chat-message";
  static const moderationReportSession =
      "${baseUrl}api/v2/moderation/reports/session";
  static const moderationReportFeedPost =
  ...
  static const loginListenerProfile =
      "${baseUrl}api/expert/fetchExpertProfile?";
  static const listenerEditProfile =
      "${baseUrl}api/expert/modifyExpertProfile?";
  static const listenerChatListApi =
      "${baseUrl}api/expert/chatTopic/getChatList?";
  static const listenerPersonalChatListApi =
      "${baseUrl}api/expert/chat/getChatHistory?";
  static const listenerSendImageAudioApi =
      "${baseUrl}api/expert/chat/dispatchChatMessage";
  static const listenerCallingHistory =
      "${baseUrl}api/expert/history/retrieveCallHistory?";
  static const listenerCoinHistory =
      "${baseUrl}api/expert/history/fetchCoinWalletHistory?";
  static const paymentOptions =
      "${baseUrl}api/expert/paymentOption/getAvailablePaymentOptions";
  static const withdrawalRecord =
      "${baseUrl}api/expert/withdrawalRecord/getPayoutRecords?";
  static const addWithdrawalRecord =
      "${baseUrl}api/expert/withdrawalRecord/addWithdrawalRecord";
  static const updateExpertCallStatus =
      "${baseUrl}api/expert/toggleExpertAvailability?";
  static const listenerCoin = "${baseUrl}api/expert/getExpertCoinBalance?";
  static const updateNotifyPermission =
      "${baseUrl}api/expert/updateNotifyPermission?";
  static const searchChatListener =
      "${baseUrl}api/expert/chatTopic/searchChattedUsers?";
  static const notificationListener =
      "${baseUrl}api/expert/notification/fetchNotifications?";
  static const clearNotificationListener =
      "${baseUrl}api/expert/notification/resetNotificationHistory?";
